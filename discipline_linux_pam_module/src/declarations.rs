...
const _: () = {
  ...
  ["Offset of field: pam_xauth_data::name"][::std::mem::offset_of!(pam_xauth_data, name) - 8usize];
  ["Offset of field: pam_xauth_data::datalen"]
    [::std::mem::offset_of!(pam_xauth_data, datalen) - 16usize];
  ["Offset of field: pam_xauth_data::data"][::std::mem::offset_of!(pam_xauth_data, data) - 24usize];
};
unsafe extern "C" {
  pub fn pam_set_data(
    pamh: *mut pam_handle_t,
