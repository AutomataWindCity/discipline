...
impl SerializableCompoundValue for RuleProtectionConditionalX {
...
impl DeserializableCompoundValue for RuleProtectionConditionalX {
  type Schema = RuleProtectionConditionalSchema;
