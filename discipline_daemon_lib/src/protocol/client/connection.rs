...
use crate::x::{TextualError, protocol::*};
...
impl ClientConnection {
  pub async fn connect(address: SocketAddr) -> Result<Self, TextualError> {
  ...
  async fn read_message(&mut self) -> Result<ServerMessage, TextualError> {
  ...
  async fn write_message(&mut self, message: &ClientMessage) -> Result<(), TextualError> {
