...
//   T: Serialize
// {
//   let content_buffer = &mut self.message_buffer[MESSAGE_CONTENT_LENGTH_SIZE..];
...
//   if content_length > self.maximum_message_content_length() {
//     return Err(
...
//         .with_attachement_display("Message maximum valid length", self.maximum_message_content_length())
...
//   let content_length_buffer = &mut self.message_buffer[0..MESSAGE_CONTENT_LENGTH_SIZE];
//   content_length_buffer.copy_from_slice(&content_length_as_u32.to_be_bytes());

//   let datagram = &self.message_buffer[
//     ..
//     MESSAGE_CONTENT_LENGTH_SIZE + content_length
//   ];
